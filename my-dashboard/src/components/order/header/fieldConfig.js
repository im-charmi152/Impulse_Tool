...
export const SUMMARY_FIELDS = [
  ...
  { key: "custBr", label: "Branch Number", icon: "Building2", type: "text" },
  {
    key: "billToCustNbr",
...
export const FIELD_GROUPS = [
  {
    ...
    defaultOpen: true,
    fields: [
      { key: "custCoCd", label: "Company Code", type: "text" },
      { key: "custBr", label: "Branch Number", type: "text" }, // was "Customer Branch"
      {
        key: "imiAsgdOrdrNbr",
        label: "Order Number",
        copyable: true,
        type: "id",
      }, // was "IMI Order Number"
      {
        key: "custPoNbr",
        label: "Customer Order Number",
        copyable: true,
        type: "id",
      }, // was "Customer PO Number"
      {
        key: "ordRefNbr",
...

  {
    ...
    defaultOpen: false,
    fields: [
      { key: "ordrStatus", label: "Border Status", type: "text" }, // was type: "status" in "Order Status" role
