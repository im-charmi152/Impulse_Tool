...
function Header({ toggleSidebar }) {
  return (
    <header className="h-14 bg-[#1D4ED8] border-b border-[#DBEAFE] flex items-center justify-between px-4 fixed top-0 left-0 right-0 z-30 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-0.5 select-none">
          ...
          <span className="text-[#DBEAFE] font-black text-xl">‑</span>
          <span className="text-white font-black text-xl tracking-tight">
            SUPPORT
          </span>
